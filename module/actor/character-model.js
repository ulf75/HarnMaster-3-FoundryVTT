 ...
 */
export class CharacterData extends CreatureTemplate {
    /* -------------------------------------------- */
    /*  Model Configuration                         */
    /* -------------------------------------------- */
                    ...
                    xp: new SchemaField$g(
                        {
                            value: new NumberField$d({
                                ...
                                min: 0,
                                initial: 0,
                                label: 'DND5E.ExperiencePoints.Current'
                            })
                        },
    ...
    prepareDerivedData() {
        ...
        if (this.attributes.hp.max === null) {
            hpOptions.advancement = Object.values(this.parent.classes)
                ...
                .filter((a) => a);
            hpOptions.bonus =
                simplifyBonus(this.attributes.hp.bonuses.level, rollData) * this.details.level +
