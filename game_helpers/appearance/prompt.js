const RIVER =
    'Create an image in a vintage etching or woodcut style. Use an earthy, muted color palette with shades of brown, beige, and dark green. Emphasize intricate linework with hatching and cross-hatching techniques to render texture and depth. Employ sharp contrasts between light and dark to create a sense of dimension. Prioritize detailed textures, organic shapes, and a rustic aesthetic reminiscent of traditional printmaking art.';

const MISTY =
    'Create an image in a vintage etching or woodcut style. Use an earthy, muted color palette with shades of green, brown, and beige. Emphasize intricate linework with hatching and cross-hatching techniques to render texture and depth. Employ sharp contrasts between light and dark to create a sense of dimension. Prioritize detailed textures, organic shapes, and a rustic aesthetic reminiscent of traditional printmaking art.';

const CATARACT =
    'Create an image in a vintage etching or woodcut style. Use an earthy, muted color palette with warm browns, deep greens, and vibrant turquoise-blue accents. Incorporate autumn tones like rich oranges to provide contrast. Emphasize intricate linework with detailed hatching and cross-hatching techniques to render texture and depth. Employ strong contrasts between light and dark to create a sense of dimension. Prioritize detailed textures, organic shapes, and a rustic aesthetic reminiscent of traditional printmaking art.';
