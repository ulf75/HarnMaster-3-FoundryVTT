(async () => {
    ...
    if (canvas.tokens.controlled.length === 1) {
        ...
        const prompt = `${DALLE} ${name} in full-size in portrait format: a medieval/dark age human ${gender} ${description}. For the background, choose something suitable from the occupation.`;
